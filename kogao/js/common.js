...
// アコーディオン FAQ sec08
  const firstHeading = $('.sec08_faq_heading').first();
  const firstContent = firstHeading.next('.sec08_accordion_content');
...
$(document).ready(function() {
	...
	function toggleMenuImage(img, src1, src2) {
	  ...
	  img.fadeOut(200, function() {
		if (src === src1) {
		  ...
		  img.attr('src', src1);
		  $('.content_wrapper').animate({ scrollTop: imgTop -40 }, 800);
		}
		img.fadeIn(500);
	  });
	}
	...
	$('#menu4').click(function() {
	  toggleMenuImage($(this), 'img/menu07.webp', 'img/menu08.webp');
	});

	$('#menu5').click(function() {
	  toggleMenuImage($(this), 'img/menu09.webp', 'img/menu10.webp');
	});
  });